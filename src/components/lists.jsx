...
export const SeriesCard = ({ data }) => {
    // console.log(props);
    const { cast, description, genre, img_url, name, rating, watch_url} = data;
    ...
    //     border: "none",
    //     fontSize: '1.6rem',
    //     backgroundColor: `${rating >= 8.5 ? "#7dcea0" : "#fcdc6f"}`,
    //     color: "var( --bg-color)",
    //     fontWeight: "bold",
    //     cursor: "pointer",
    // })
    ...
    const ButtonThapa = styled.button`
        ...
        border: none;
        font-size: 1.6rem;
        background-color: ${(props) => props.rating >= 8.5 ? "#7dcea0" : "#fcdc6f"};
        color: var( --bg-color);
        font-weight: bold;
        cursor: pointer;
        `
